...
"""
    ...
    def calculate_simple_similarity(self, cluster1: Dict, cluster2: Dict) -> float:
        """Calculate simple similarity between two clusters based on message content"""
        try:
            ...
            "response": """
{
  ...
  "refined_clusters": [
    ...
    def evaluate_model(self, provider: str, model_name: str, phase3_result: Dict) -> Dict[str, Any]:
        ...
        print(f"    🔍 Calculating similarities between clusters...")
        cluster_similarities = []
        for i, cluster1 in enumerate(clusters):
            for j, cluster2 in enumerate(clusters[i+1:], i+1):
                similarity = self.calculate_simple_similarity(cluster1, cluster2)
