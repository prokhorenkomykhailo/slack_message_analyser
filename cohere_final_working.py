#!/usr/bin/env python3
"""
Final working Cohere implementation that uses cached model
No re-downloading, proper memory management
"""
...
def test_cohere_final():
    """Final working Cohere test using cached model"""
...
Return JSON clusters."""
        ...
        with open("output/cohere_final_results.json", "w") as f:
            json.dump(result, f, indent=2)
        
        print("\n💾 Results saved to output/cohere_final_results.json")
        print("\n🎉 Cohere is working with cached model!")
        print("🚀 No re-downloading, using cached version!")
...
def main():
    ...
    print("🔧 Starting final Cohere test...")
    print("This version uses cached model with proper memory management")
    
    if test_cohere_final():
        print("\n🎯 SUCCESS!")
        print("=" * 15)
